...
import assetTypes, { IAssetTypesList } from '@const/AssetTypes'
...
const Indicators = ({ reits, goodReits }: IndicatorsProps) => {
  ...
  return (
    <Template tabTitle="indicadores-fiis">
      <Tabs
        assetTypes={tabsList}
        activeTab={{ title: 'FIIs', name: 'reits' }}
        setActiveTab={(tab: any) =>
          Router.push(`/indicadores/${tab.title.toLowerCase()}`)
        }
      />
      <SearchBar
